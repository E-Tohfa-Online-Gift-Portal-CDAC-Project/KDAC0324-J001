...
public class ETohfaBackendApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		User admin = this.userService.getUserByEmailIdAndRoleAndStatus("abhi@etohfa.com",
		...
		if (admin == null) {
			...
			User user = new User();
			user.setEmailId("admin@etohfa.com");
			user.setPassword(passwordEncoder.encode("Abhi12"));
